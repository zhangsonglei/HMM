 ...
 *</ul>
 */
public class HMModel implements HMM {
	...
	public HMModel(int order, Dictionary dict, HashMap<State, ARPAEntry> pi, HashMap<StateSequence, TransitionProbEntry>  transitionMatrix, HashMap<State, EmissionProbEntry>  emissionMatrix) {
		this.order = order;
		this.dict = dict;
		this.pi = pi;
